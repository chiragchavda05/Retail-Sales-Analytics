...
“A retail sales analytics project using Excel, SQL, Python, and Power BI”


## 📌 Project Overview
This project is a Retail Sales & Business Intelligence Analytics System built using Excel, SQL, Power BI, and Python.
It uses a real-world retail sales dataset to analyze sales performance, profit, trends, and business insights.
...
- SQL – Data querying and insight extraction (executed on an online SQL platform)  
- Python (Jupyter Notebook) – Data analysis and visualizations  
...
## 🔍 Project Workflow
1. Cleaned and prepared raw retail sales data using Excel.
2. Converted data into CSV format for SQL analysis.
3. Executed SQL queries on an online SQL platform (screenshots included).
4. Performed data analysis in Python using Jupyter Notebook.
